...
public class Queries {
	...
	public static boolean insertBook(String title, String authorFname, String authorLname, int releasedYear, int stockQuantity, int pages) {
		Connection conn = null;
		PreparedStatement stmt = null;
		boolean status = false;
		try {
			conn = DBConnection.getConnection();
			String sql = "INSERT INTO books (title, author_fname, author_lname, released_year, stock_quantity, pages) "
			 + "VALUES ( ?, ?, ?, ?, ?, ?)";
	...
	public static boolean updateBook(int bookId, String title, String authorFname, String authorLname, int releasedYear, int stockQuantity, int pages) {
		Connection conn = null;
		PreparedStatement stmt = null;
		boolean status = false;
